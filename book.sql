...
CREATE TABLE `staple`  (   `id` int(11) NOT NULL AUTO_INCREMENT,   `name` varchar(20) DEFAULT NULL,   PRIMARY KEY (`id`) USING BTREE ) ENGINE = InnoDB AUTO_INCREMENT = 1;

CREATE TABLE `sauce`  (   `id` int(11) NOT NULL AUTO_INCREMENT,   `name` varchar(20) DEFAULT NULL,   PRIMARY KEY (`id`) USING BTREE ) ENGINE = InnoDB AUTO_INCREMENT = 1;

CREATE TABLE `vegetable`  (   `id` int(11) NOT NULL AUTO_INCREMENT,   `name` varchar(20) DEFAULT NULL,   PRIMARY KEY (`id`) USING BTREE ) ENGINE = InnoDB AUTO_INCREMENT = 1;

INSERT INTO `staple` (name) VALUES ('Pizza');
INSERT INTO `staple` (name) VALUES ('Sandwich');
INSERT INTO `staple` (name) VALUES ('Noodle');

INSERT INTO `sauce` (name) VALUES ('Salad');
INSERT INTO `sauce` (name) VALUES ('Ketchup');
INSERT INTO `sauce` (name) VALUES ('Mushroom');
